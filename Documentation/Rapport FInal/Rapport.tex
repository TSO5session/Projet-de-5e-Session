...
\begin{center}
\fbox{\includegraphics[scale=1]{Figures/DoxyFESTO/1.pdf}}\\
\begin{multicols}{3}
\fbox{\includegraphics[scale=0.14]{Figures/DoxyFESTO/2.pdf}}\\
\fbox{\includegraphics[scale=0.1]{Figures/DoxyFESTO/3.pdf}}\\
\fbox{\includegraphics[scale=0.14]{Figures/DoxyFESTO/4.pdf}}\\
\end{multicols}
\end{center}
\pagebreak
...
\begin{center}
\fbox{\includegraphics[scale=1]{Figures/DoxyBolide/1.pdf}}\\
\bigskip
\fbox{\includegraphics[scale=1]{Figures/DoxyBolide/2.pdf}}
\end{center}
...
Il est à noter que nous avons dû réaliser un correctif lors de la soudure de la carte IO du projet. La zone de ground plane en bleu devait être reliée à GND, c'est-à-dire la zone verte, mais ce n'était pas la cas. C'est pourquoi un bout de fil à été soudé afin de pailler à ce manque.
