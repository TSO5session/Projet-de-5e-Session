...
void CLStation1 :: vControleStation1(void)
 {
   ...
   UC    var2 = 0x32;
     ...
     // clEcranST1.vLCDDisplayHexCarac(clCANST1.Tab [0]);
     // clEcranST1.vLCDDisplayHexCarac(clCANST1.Tab [1]);
     // clEcranST1.vLCDDisplayHexCarac(clCANST1.Tab [2]);
      //clEcranST1.vLCDDisplayHexCarac(clCANST1.Tab [3]);
      //clEcranST1.vLCDDisplayHexCarac(clCANST1.Tab [4]);
   ...
   switch (clCANST1.Tab [0])
    ...
    case 0x09:
      if (clCANST1.Tab [1] == 0x00)
      {
        clXbeeST1.vTransChaine("1 EE ");  
      }
      break;
      
    case 0x08:
     if (clCANST1.Tab [1] == 0x00) clXbeeST1.vTransChaine("2 L02");
         
     if (clCANST1.Tab [1] == 0x01) clXbeeST1.vTransChaine("2 L00");
     break;     
    }       
       ...
       switch(TrameRxST1[2])             //Commande recue?
        ...
        case 'L':
          if (TrameRxST1[4] == '0') 
          {
            ...
            clCANST1.EnvoyerTrameMCP2515 ("42");
          }
          if (TrameRxST1[4] == '1') 
          {
                  clEcranST1.vLCDCursor(0,3);
               clEcranST1.vLCDDisplayHexCarac(var);
               
            clCANST1.EnvoyerTrameMCP2515 ("40");
          }
          if (TrameRxST1[4] == '2') 
          {
                              clEcranST1.vLCDCursor(0,3);
               clEcranST1.vLCDDisplayHexCarac(var);
            clCANST1.EnvoyerTrameMCP2515 ("41");
          }
         break;  
        }
      }
     
    if(TrameRxST1[0] == '3' &&          //Trame recue de la station 2
       TrameRxST1[1] == ' ')
      {
       switch(TrameRxST1[2])             //Commande recue?
        {
        case 'A':
          clCANST1.EnvoyerTrameMCP2515 ("10");
          if (TrameRxST1[3] == '3') 
          {
            clCANST1.EnvoyerTrameMCP2515 ("70");
          }
          if (TrameRxST1[3] == '1') 
          {
            clCANST1.EnvoyerTrameMCP2515 ("71");
          }
         break;
         
        default:
          clCANST1.EnvoyerTrameMCP2515 ("11");
         break; 
        }
      }     
