...
#define STATION_2 
   ...
   union UOUT1 uOUT1;
   union UOUT2 uOUT2;
   union UDRIVEIN uDRIVEIN;
   union UDRIVEOUT uDRIVEOUT;
   ...
   //   clTestEcran.vLCDDisplayEtatPort(IN_1.ucLireIOPCF());
       OUT_1.vEcrireIOPCF (0xAA);

       OUT_2.vEcrireIOPCF (0x55); 
         clTestEcran.vLCDCursor(0,3);
         clTestEcran.vLCDDisplayEtatPort(IN_1.ucLireIOPCF());
       for (long i=0; i < 65000; i++);
       OUT_1.vEcrireIOPCF (0x55);
         clTestEcran.vLCDCursor(10,3);
         clTestEcran.vLCDDisplayEtatPort(IN_2.ucLireIOPCF());    
       OUT_2.vEcrireIOPCF (0xAA);       
       for (long i=0; i < 65000; i++);
       ...
       OUT_1.vEcrireIOPCF(0xFF);
       OUT_2.vEcrireIOPCF(0xFF);
       
       
       if(uIN1.in1.BOUTON_DEPART == 1)
       {
