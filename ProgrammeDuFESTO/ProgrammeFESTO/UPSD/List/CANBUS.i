#line 1 "C:\\Synchro\\Dropbox\\Travaux\\Automne 2014\\ProjetSession5\\ProgrammeDuFESTO\\ProgrammeFESTO\\CANBUS.cpp"
// **************************CANBUS.cpp
...
#line 12 "C:\\Synchro\\Dropbox\\Travaux\\Automne 2014\\ProjetSession5\\ProgrammeDuFESTO\\ProgrammeFESTO\\CANBUS.cpp"
...
#line 13 "C:\\Synchro\\Dropbox\\Travaux\\Automne 2014\\ProjetSession5\\ProgrammeDuFESTO\\ProgrammeFESTO\\CANBUS.h"
#line 1 "C:\\Synchro\\Dropbox\\Travaux\\Automne 2014\\ProjetSession5\\ProgrammeDuFESTO\\ProgrammeFESTO\\MCP2515.h"
...
//LinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxTUX
#line 13 "C:\\Synchro\\Dropbox\\Travaux\\Automne 2014\\ProjetSession5\\ProgrammeDuFESTO\\ProgrammeFESTO\\CANBUS.cpp"
#line 1 "C:\\Synchro\\Dropbox\\Travaux\\Automne 2014\\ProjetSession5\\ProgrammeDuFESTO\\ProgrammeFESTO\\MCP2515.h"
...
/* Registres permettant de contrôler le module de réception « RX0 » */
#line 14 "C:\\Synchro\\Dropbox\\Travaux\\Automne 2014\\ProjetSession5\\ProgrammeDuFESTO\\ProgrammeFESTO\\CANBUS.cpp"
...
{
//  MCP2515_RXB0DLC // Registre de la longueur du message
//UC PointeurRegistre  = MCP2515_RXB0D0; // Registre de lecture  
//UC k;                                  // Pour la boucle for 
UC Low5              = 0;  // 3 octet du bas
UC High3             = 0;  // 8 octet du haut
  
EcrireRegistreMCP2515(0x0F, 0x03);// Mode LoopBak 03 ou 02?  

UC Identifiant       = 0;  
UC LongueurDuMessage = 0;  // Pour lire la longeur du message

LongueurDuMessage = WriteMPC(0x65);
LongueurDuMessage = LongueurDuMessage & 0x00FF; // Bit d'obtemtion de longueur

Low5              = WriteMPC(0x62); // Lecture des 3 bits de l'octet du bas
High3             = WriteMPC(0x61); // Lecture des 8 bits de l'octet du haut

Low5  = Low5  >> 5; // Décalage de 3
High3 = High3 << 3; // Decalage de 5

Identifiant = Low5 + High3;

Identifiant = Low5 + High3;

//Le MCP2515 est informé du nombre d'octets de données qu'il aura à recevoir

EcrireRegistreMCP2515(0x0F, 0x07);   // Retour au mode normal
return(Identifiant);
}
