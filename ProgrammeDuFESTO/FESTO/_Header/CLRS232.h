...
//                                                                           //
///////////////////////////////////////////////////////////////////////////////
#ifndef CLRS232H                  // Si CLRS232H non defini.
   #define CLRS232H               // Defini CLRS232H

#include "DeclarationGenerale.h"  // Pour les declaration generale
#include "TypeCible.h"            // Pour les definition des registre.
#include "ConversionKeilToIAR.h"  //
#include "ConversionKeilToIAR.h"  //

#define LONGUEURTRAME  6          // Longueur trame par defaut.
...
class CLRS232                     // Classe CLCommunic
{
public:                           // Menbres publics.
   CLRS232(void);                                    // Constructeur par defaut.
   CLRS232(UC ucLongBuf, UC ucLongTrame, UI uiBaud); // Constructeur initialisateur
  ~CLRS232(void);                                    // Destructeur
