...
#define BROCHE_MCP2515_SCK P1_6
#define BROCHE_MCP2515_SDO P1_4
#define BROCHE_MCP2515_SDI P1_5
#define MCP2515_CHOIX_IDENTIFIANT 0x02

class CLMCP2515 : public CLSerialPortInterface
 {
   public:
    CLMCP2515(void);
   ~CLMCP2515(void);
    ...
    void InitialisationSPI(void);
    void LireMCP2515(void);
