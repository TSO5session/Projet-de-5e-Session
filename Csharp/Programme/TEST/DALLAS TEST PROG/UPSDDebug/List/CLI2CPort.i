#line 1 "C:\\Synchro\\Dropbox\\Travaux\\Automne 2014\\Prog\\Labo1\\Programme\\CLI2CPort.Cpp"
// ************************** FICHIER: CLI2CPORT.CPP ************************
#line 1 "C:\\Synchro\\Dropbox\\Travaux\\Automne 2014\\Prog\\Labo1\\Programme\\CLI2CPort.h"
// ************************** FICHIER: CLI2CPORT.H *****************************
//
...
//LinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxTUX
#line 26 "C:\\Synchro\\Dropbox\\Travaux\\Automne 2014\\Prog\\Labo1\\Programme\\CLI2CPort.h"
#line 1 "C:\\Synchro\\Dropbox\\Travaux\\Automne 2014\\Prog\\Labo1\\Programme\\CLI2CBase.h"
// ************************** FICHIER: CLI2CBASE.H *****************************
//
...
//LinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxTUX
#line 32 "C:\\Synchro\\Dropbox\\Travaux\\Automne 2014\\Prog\\Labo1\\Programme\\CLI2CBase.h"
...
//LinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxTUX
#line 27 "C:\\Synchro\\Dropbox\\Travaux\\Automne 2014\\Prog\\Labo1\\Programme\\CLI2CPort.h"
...
//LinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxLinuxTUX
#line 3 "C:\\Synchro\\Dropbox\\Travaux\\Automne 2014\\Prog\\Labo1\\Programme\\CLI2CPort.Cpp"
...
UC CLI2CPort :: ucI2CLireDonnee(UC ucAdrBoitier, UC ucAdrRegistre)
 {
   ...
   vI2CStart();
   while(ucI2CEcrireOctet(ucAdrBoitier + 0)== 1)
    {
      vI2CStart();
    }
   while(ucI2CEcrireOctet(ucAdrRegistre)       == 1);
   vI2CStart();
   while(ucI2CEcrireOctet(ucAdrBoitier + 1) == 1)
    {
      vI2CStart();
    }
   ucReadOctet = ucI2CLireOctet(1);
   vI2CStop();
   return(ucReadOctet);
 }
...
//----------------------------------------------------------------------
      case 1:
       ...
       while(ucI2CEcrireOctet(unAdresse.stDoubleOctet.ucOctet1) == 1);
       vI2CStart();
       while(ucI2CEcrireOctet(ucAdrBoitier + 1)              == 1)
         {
           vI2CStart();
...
//----------------------------------------------------------------------
      case 2:
       ...
       while(ucI2CEcrireOctet(unAdresse.stDoubleOctet.ucOctet1) == 1);
       while(ucI2CEcrireOctet(unAdresse.stDoubleOctet.ucOctet2) == 1);
       vI2CStart();
       while(ucI2CEcrireOctet(ucAdrBoitier + 1)              == 1)
         {
           vI2CStart();
   ...
   if(ucNbrLectures > 1)
    {
      for(UC i = 0; i < ucNbrLectures - 1; i++)
       {
         ucpRecevoirDonnee[i] = ucI2CLireOctet(0);
       }
    }
   ucpRecevoirDonnee[ucNbrLectures - 1] = ucI2CLireOctet(1);
   vI2CStop();
  }
...
void CLI2CPort :: vI2CEcrireDonnee(UC ucAdrBoitier, UC ucAdrRegistre,
                                   UC ucDonnee)
 {
   ...
   while(ucI2CEcrireOctet(ucAdrRegistre)        == 1);
   while(ucI2CEcrireOctet(ucDonnee)             == 1);
   vI2CStop();
 }
   ...
   if(ucNbrEcritures > 1)
    {
      for(UC i = 0; i < ucNbrEcritures; i++)
       {
         while(ucI2CEcrireOctet(ucpDonnee[i])== 1);
       }
    }
