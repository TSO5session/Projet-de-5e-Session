#line 1 "J:\\Projet_Session5_LNAH\\S2_18Nov2014\\Programme Station 2\\FESTO\\Libraire\\CLInOutBase.cpp"
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#line 23 "J:\\Projet_Session5_LNAH\\S2_18Nov2014\\Programme Station 2\\FESTO\\Libraire\\CLInOutBase.cpp"
#line 1 "J:\\Projet_Session5_LNAH\\S2_18Nov2014\\Programme Station 2\\FESTO\\Libraire\\_DeclarationGenerale.h"
...
#line 24 "J:\\Projet_Session5_LNAH\\S2_18Nov2014\\Programme Station 2\\FESTO\\Libraire\\CLInOutBase.cpp"
                         ...
                         unsigned char ucTypeTransfert)
{
  ...
  {
    case 0U://2 acces 8 bits a la meme adresse, LSB en premier. 
      vOutportb( usiAdresse,unMot16bit.stOctet16bit.ucBas);  
      vOutportb( usiAdresse,unMot16bit.stOctet16bit.ucHaut);
    
    break;
    
    case 1U://2 acces 8 bits a la meme adresse, MSB en premier.
     vOutportb(usiAdresse,unMot16bit.stOctet16bit.ucHaut);
    vOutportb(usiAdresse, unMot16bit.stOctet16bit.ucBas);
    break;
    
    case 2U://2 acces 8 bits adresses successives, LSB en  premier
      vOutportb(usiAdresse,unMot16bit.stOctet16bit.ucBas);
      vOutportb(((usiAdresse)+1), unMot16bit.stOctet16bit.ucHaut);
    break;
    
    case 3U://2 acces 8 bits adresses successives, MSB en premier 
        vOutportb(usiAdresse, unMot16bit.stOctet16bit.ucHaut);
...
{
   UC ucDonnee;
   ucpAdresse = (UC __xdata *) usiAdresse; //Affecte l'adresse du peripherique 
                                         //au pointeur 
...
void  CLInOutBase :: vOutportb(unsigned short int usiAdresse, 
                                       unsigned char ucDonnee)
{
   ucpAdresse = (UC __xdata *) usiAdresse;//Affecte l'addresse du peripherique 
                                        //au pointeur 
