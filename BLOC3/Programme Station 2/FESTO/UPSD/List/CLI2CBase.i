#line 1 "J:\\Projet_Session5_LNAH\\S2_18Nov2014\\Programme Station 2\\FESTO\\Libraire\\CLI2CBase.cpp"
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#line 14 "J:\\Projet_Session5_LNAH\\S2_18Nov2014\\Programme Station 2\\FESTO\\Libraire\\CLI2CBase.cpp"
#line 1 "J:\\Projet_Session5_LNAH\\S2_18Nov2014\\Programme Station 2\\FESTO\\Libraire\\_DeclarationGenerale.h"
...
#line 15 "J:\\Projet_Session5_LNAH\\S2_18Nov2014\\Programme Station 2\\FESTO\\Libraire\\CLI2CBase.cpp"
...
#line 16 "J:\\Projet_Session5_LNAH\\S2_18Nov2014\\Programme Station 2\\FESTO\\Libraire\\CLI2CBase.cpp"
...
{
  P1_bit . P14 = 1; //Place la ligne de donnée a 1
  P1_bit . P15 = 1; //Place la ligne d'horloge a 1
  vDelais();  //Cree un delai pour que les lignes soient stable
  P1_bit . P14 = 0;  //Place la ligne de donnée a 0
  vDelais();  //Delai pour la stabilité
  P1_bit . P15 = 0;  //Ligne d'horloge a 0
  vDelais();  //Delai pour la stabilité   
}
...
void CLI2CBase :: vI2CStop(void)
{
  P1_bit . P14 = 0; //Place la ligne de donnée a 0
  vDelais(); //Delai pour la stabilité
  P1_bit . P15 = 1;//Ligne d'horloge a 1 pour changer la donnée
  vDelais(); //Delai pour la stabilité
  P1_bit . P14 = 1;//Place la ligne de donnée a 1
  vDelais();//Delai pour la stabilité
}
	...
	ucVal = ucVal + 1;       //Additionne 1 a la variable ucVal
      ...
      {                          //
        ucVal = ucVal << 1;      //Decale a gauche de 1 pour placer un 0
                                 ...
                                 //
     P1_bit . P14 = ucAckNoAck;	         //Envoie Le signal ACK
   }                             //
                                 //
                                 //
  return(ucVal);                 //
...
UC CLI2CBase :: ucI2CLireBit(void)
{
  UC ucBit;      //Declare une variable pour stocker le bit lu
		               // 
  P1_bit . P14 = 1;    //Met la ligne de donnée a 1 
  vDelais();     //Attend que sa se stabilise
  P1_bit . P15 =  1;   //L'horloge mis a 1
  vDelais();     //Attend que sa se stabilise
  ucBit = P1_bit . P14;   //Stocke le bit lu
  vDelais();     //Attend que sa se stabilise
  P1_bit . P15 = 0;     //Horloge mis a 0
  vDelais();     //Attend que sa se stabilise
...
{
   P1_bit . P14 = ucValeur;         //Envoie un bit sur la ligne de donnee
   vDelais();              //
   P1_bit . P15 = 1;             //Ligne d'horloge a 1
   vDelais();              //
   P1_bit . P15 = 0;              //Ligne d'horloge a 0
   vDelais();              //
...
void CLI2CBase ::  vDelais(void)
{
  ...
  for( i=0 ;i < 100; i++);//Compte un nombre de fois pour faire un delai 
