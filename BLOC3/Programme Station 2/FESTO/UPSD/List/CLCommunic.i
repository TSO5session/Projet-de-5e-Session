#line 1 "J:\\Projet_Session5_LNAH\\S2_18Nov2014\\Programme Station 2\\FESTO\\Libraire\\CLCommunic.cpp"
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#line 23 "J:\\Projet_Session5_LNAH\\S2_18Nov2014\\Programme Station 2\\FESTO\\Libraire\\CLCommunic.cpp"
#line 1 "J:\\Projet_Session5_LNAH\\S2_18Nov2014\\Programme Station 2\\FESTO\\Libraire\\_DeclarationGenerale.h"
...
#line 24 "J:\\Projet_Session5_LNAH\\S2_18Nov2014\\Programme Station 2\\FESTO\\Libraire\\CLCommunic.cpp"
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#line 25 "J:\\Projet_Session5_LNAH\\S2_18Nov2014\\Programme Station 2\\FESTO\\Libraire\\CLCommunic.cpp"
...
#pragma vector = 0x23
 ...
 {
    IE_bit . EA = 0;        //Desactive les interuptions
   
   if(SCON_bit . RI)       //Si Reception
    {  
      ...
      *ucpEcritureTampon = SBUF; //Stocke le caractere recu dans tampon
      ...
      if(ucCompteurCarac < (ucLongeurTampon-1)) //Si nombre caract recu est 
      ...
      else                                 //sinon
       {
        ...
        ucTrameRecu = 1;       //Trame complete vaut vrai
        ucpEcritureTampon = ucpDebutTampon;
        ucpLireTampon  = ucpDebutTampon;
     ...
     SCON_bit . RI = 0;                           //reinitialise flag reception
     IE_bit . EA   = 1;                           // re initialise les interuptions
