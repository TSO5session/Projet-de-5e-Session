...
{
UC maVar = CAN.LireMCP2515();       // Lit l'heure en provenance du PC 
...
Clock.vReadTime(); 
Clock.vReadDate(); 
CAN.EnvoyerTrameMCP2515("À faire: trouver comment envoyer l'heure");
}
...
{
  CAN.EnvoyerTrameMCP2515(Message);  // Note: il faut gérer l'ID (EX.: PC = 000; SOC = 001, etc)
}
