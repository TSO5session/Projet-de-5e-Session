...
//
//
//CLRS232()                                         Constructeur par defaut
//CLRS232(UC ucLongBuf, UC ucLongTrame, UI uiBaud)  Construct initialisateur
//~CLRS232()                                        Destructeur
//
...
//                                                                           //
///////////////////////////////////////////////////////////////////////////////
#include "CLRS232.h"             //inclue CLRS232.h.
#include "ConversionKeilToIAR.h"
///// Initialise les variables statiques.
UC    CLRS232 :: ucEtatTrame       = INCOMPLET      ; // Trame incomplete.
UC    CLRS232 :: ucNbCaractRecu    = 0              ; // Nombre de caractere recu = 0
UC    CLRS232 :: ucLongueurTrame   = LONGUEURTRAME  ; // Initialise les longueur du
UC    CLRS232 :: ucLongueurTampon  = LONGUEURTAMPON ; // buffer et trame.
UC    CLRS232 :: ucCaractereRecu   = NULL           ;
UC    CLRS232 :: ucEtatReception   = INACTIF        ;
char *CLRS232 :: cpDebutTrame      = NULL           ; // Initialise lse pointeur a NULL.
char *CLRS232 :: cpFinTrame        = NULL           ;
char *CLRS232 :: cptrEcriture      = NULL           ;
char *CLRS232 :: cptrLecture       = NULL           ;
char *CLRS232 :: cTabCaractereRecu = NULL           ;

//*****************************************************************************
// Nom de la fct       : CLRS232(void)
...
//
// INCLUDE             :#include "_TypeCible.h", "CLRS232.h"
// Prototype           : CLRS232(void);
//
//
...
//
// Exemple d'appel     : class CLRS232 CLRS232();
//
...
//
// INCLUDE              : #include "_TypeCible.h", "CLRS232.h"
// Prototype            : CLRS232(UC ucLongBuf, UC ucLongTrame, UI uiBaud);
//
//
...
// Modification         :
//*****************************************************************************
CLRS232 :: CLRS232(UC ucLongBuf, UC ucLongTrame, UI uiBaud)
{
...
UC CLRS232 :: ucInitLongTrame(UC ucLong)
{
...
//
// Exemple d'appel: CLRS232.Send('A')
//*****************************************************************************
void CLRS232 :: Send(UC ucCar)
{
...
//
// Exemple d'appel: CLRS232.SendString("TEST");
//
...
// Modification :
//*****************************************************************************
void CLRS232 :: SendString(char const *ucpMessage)
{
...
//*****************************************************************************
UC CLRS232 :: ucLireNbCaractRecu(void)
{
...
//*****************************************************************************
UC CLRS232 :: ucLireEtatTrame(void)
{
...
//*****************************************************************************
char *CLRS232 :: ucpLireTrame(void)
{
...
//*****************************************************************************
void CLRS232:: vInitBaudRate(UI uiBaud)
{
SCON0 = 0x50;         // SM0_0=0
                      // SM1_0=1
...
switch(uiBaud)         // switch case pour determiner la valeur en
  {                    // hexa qui faut mettre a TH1 pour avoir la
                       // bonne vitesse du timer pour generer le baudrate
   case 57600:         
      TH1= 0xFF;
   break;
   case 38400:
...
//
// INCLUDE:         #include "_TypeCible.h", "CLRS232.h"
// Prototype:       __interrupt  void CLRS232:: vInteruptSerial(void);
//
...
#pragma vector=0x23  // Interrupt 4 pour interruption serie au vecteur 23
 __interrupt  void CLRS232:: vInteruptSerial(void)
{
...
// Modification :
//*****************************************************************************
void CLRS232 :: SendNumber(UI uiChiffreAAfficher)
{
...
UC CLRS232 :: GetChar(void)
{
ucEtatReception = INACTIF;
return(ucCaractereRecu);
}

UC CLRS232 :: ucLireEtatReception(void)
{
